document.addEventListener('DOMContentLoaded', function () {
    ...
    // Récupération et affichage des stations Vélib
    ...
    const restaurantApiUrl = 'http://localhost:8000/GetAllResto';
    Restaurant.fetchRestaurants(restaurantApiUrl)
        .then(restaurants => {
    ...
    const incidentApiUrl = 'http://localhost:8000/GetIncident';
    Incident.fetchIncidents(incidentApiUrl)
        .then(incidents => {
